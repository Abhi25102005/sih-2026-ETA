...
function App() {
  ...
  useEffect(() => {
    ...
    localStorage.setItem("railpulse-theme", dark ? "dark" : "light");
  }, [dark]);
    ...
    <div className="login-shell">
      <div className="login-art">
        <button className="back-link" onClick={onBack}>
          <ChevronRight size={14} className="back-arrow" />
          Back to RailPulse
        </button>
        ...
        <div className="art-copy">
          <p className="eyebrow">REAL-TIME RAIL INTELLIGENCE</p>
          ...
          <p>
            Arrive with clarity. RailPulse turns live
            movement into a calmer journey for every
            passenger.
          </p>
        </div>
        ...
        <div className="art-route">
          ...
          <div>
            <b>06:20</b>
            <small>New Delhi ETA</small>
          </div>
        </div>

        <span className="art-stamp">PHASE 01 / LIVE</span>
      </div>

      <div className="login-panel">
        <div className="panel-top">
          <span className="panel-kicker">PASSENGER PORTAL</span>
        ...
        <div className="login-heading">
          <h2>Welcome back.</h2>
          <p>Sign in to see your journey in motion.</p>
        </div>
        ...
        <form onSubmit={submit}>
          ...
          <button
            ...
            disabled={loading}
          >
            {loading ? "Signing in..." : "Enter RailPulse"}

            {!loading && <ChevronRight size={17} />}
          </button>
        </form>

        <button className="switch-auth" onClick={onSignUp}>
          New to RailPulse?{" "}
          <strong>Create an account</strong>
        </button>

        <div className="login-footer">
          <span>Indian Railways prototype</span>
          <span>v0.1.0</span>
        </div>
      </div>
    </div>
    ...
    <div className="signup-shell">
      <div className="signup-aside">
        ...
        <div>
          ...
          <p>
            Create a lightweight RailPulse profile and
            keep your watch points close at hand.
          </p>
        </div>
        ...
        <div className="signup-benefits">
          <span>
            <Check size={15} />
            Personal journey workspace
          </span>

          <span>
            <Check size={15} />
            Live train signal updates
          </span>
